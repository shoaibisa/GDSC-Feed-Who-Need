      ...
      <div className={styles.signin__content}>
        <div className={styles.signin__page}>
          ...
          >
            ...
            <label htmlFor="name" className={styles.signin__label}>
            ...
            <input
              ...
              autoComplete='off'
            />
            <label htmlFor="phone" className={styles.signin__label}>
              Contact Number
            </label>
            <input
              type="tel"
              ...
              autoComplete='off'
            />
            <label htmlFor="address" className={styles.signin__label}>
              Address
            </label>
             <input
              ...
              onChange={(e) => setAddress(e.target.value)}
                name="address"
              />
                 <label htmlFor="pincode" className={styles.signin__label}>
              Pin-Code
            </label>
             <input
